...
export default function Home({ blogs }: Props) {
  return (
    <div className='bg-gray-700 min-h-screen relative pb-12'>
      <Head></Head>
      <div className='pt-3 '>
        ...
        <ul className='md:flex md:grid md:grid-cols-2 lg:grid-cols-4 pl-5 pr-5 pb-5 pt-5'>
          {blogs.map((blog) => (
            ...
            <div key={blog.id} className='bg-gray-800 md:w-4/5  mb-5 ml-auto mr-auto p-2 pr-3 pl-3 rounded h-24 md:h-72'>
              ...
              <li key={blog.id} className="h-full ">
                <Link href={`/blog/${blog.id}`}>
                  ...
                  <div className='flex md:flex-auto md:flex-col h-4/5  mt-2 '>
                    {/* サムネの高さを統一 */}
